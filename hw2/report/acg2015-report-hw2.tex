...
\paragraph*{Time needed} 17 hours
\paragraph*{Main problems encountered}
\begin{itemize}
\item Understanding the intricacies of the theory.
\item Figuring out what is $\omega_i$ and $\omega_o$ without confusing them.
\item Projecting from the perfect specular reflective reference frame to the local reference frame before figuring out that the \textit{Frame} class could help us.
\end{itemize}
